...
public class MultiDirectionalTest extends TestCase {
	...
	public void testFunctionEvaluationExceptions() {
		MultivariateRealFunction wrong = new MultivariateRealFunction() {
	...
	public void testRosenbrock() throws FunctionEvaluationException, ConvergenceException {
		...
		optimizer.setStartConfiguration(new double[][] { { -1.2, 1.0 }, { 0.9, 1.2 }, { 3.5, -2.3 } });
	...
	public void testPowell() throws FunctionEvaluationException, ConvergenceException {

		MultivariateRealFunction powell = new MultivariateRealFunction() {
		...
		RealPointValuePair optimum = optimizer.optimize(powell, GoalType.MINIMIZE,
