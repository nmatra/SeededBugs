...
public interface FieldMatrix<T extends FieldElement<T>> extends AnyMatrix {
	...
	/**
	 * Create a new FieldMatrix<T> of the same type as the instance with the
	 ...
	 */
	FieldMatrix<T> getSubMatrix(int startRow, int endRow, int startColumn, int endColumn) throws MatrixIndexException;
	 ...
	 */
	FieldMatrix<T> getSubMatrix(int[] selectedRows, int[] selectedColumns) throws MatrixIndexException;
	 ...
	 * @since 2.0
	 */
	void setSubMatrix(T[][] subMatrix, int row, int column) throws MatrixIndexException;
	 ...
	 */
	void setRowMatrix(int row, FieldMatrix<T> matrix) throws MatrixIndexException, InvalidMatrixException;
	 ...
	 */
	void setColumnMatrix(int column, FieldMatrix<T> matrix) throws MatrixIndexException, InvalidMatrixException;

	/**
	 * Returns the entries in row number <code>row</code> as a vector. Row
	 * indices start at 0.
	 *
	 * @param row
	 *            the row to be fetched
	...
	/**
	 * Sets the entries in row number <code>row</code> as a vector. Row indices
	 * start at 0.
	 *
	 * @param row
	 *            the row to be set
	 * @param vector
	 *            row vector (must have the same number of columns as the
	 *            instance)
	 * @throws MatrixIndexException
	 *             if the specified row index is invalid
	 * @throws InvalidMatrixException
	 ...
	 */
	void setRowVector(int row, FieldVector<T> vector) throws MatrixIndexException, InvalidMatrixException;

	/**
	 * Returns the entries in column number <code>column</code> as a vector.
	 * Column indices start at 0.
	 *
	 * @param column
	 *            the column to be fetched
	...
	/**
	 * Sets the entries in column number <code>column</code> as a vector. Column
	 * indices start at 0.
	 *
	 * @param column
	 *            the column to be set
	 * @param vector
	 *            column vector (must have the same number of rows as the
	 *            instance)
	 * @throws MatrixIndexException
	 *             if the specified column index is invalid
	 * @throws InvalidMatrixException
	 ...
	 */
	void setColumnVector(int column, FieldVector<T> vector) throws MatrixIndexException, InvalidMatrixException;
	 ...
	 *            the row to be set
	 * @param array
	 *            row matrix (must have the same number of columns as the
	 *            instance)
	 * @throws MatrixIndexException
	 *             if the specified row index is invalid
	 * @throws InvalidMatrixException
	 ...
	 */
	void setRow(int row, T[] array) throws MatrixIndexException, InvalidMatrixException;
	 ...
	 *            the column to be set
	 * @param array
	 *            column array (must have the same number of rows as the
	 *            instance)
	 * @throws MatrixIndexException
	 *             if the specified column index is invalid
	 * @throws InvalidMatrixException
	 ...
	 */
	void setColumn(int column, T[] array) throws MatrixIndexException, InvalidMatrixException;
	 ...
	 *            column location of entry to be set
	 * @param factor
	 *            multiplication factor for the current matrix entry in
	 *            row,column
	 * @throws MatrixIndexException
	 *             if the row or column index is not valid
	 * @since 2.0
	 ...
	 *                if the visitor cannot process an entry
	 ...
	 * @see #walkInOptimizedOrder(FieldMatrixChangingVisitor, int, int, int,
	 *      int)
	 * @see #walkInOptimizedOrder(FieldMatrixPreservingVisitor, int, int, int,
	 *      int)
	 * @return the value returned by {@link FieldMatrixChangingVisitor#end()} at
	 *         the end of the walk
	 */
	T walkInRowOrder(FieldMatrixChangingVisitor<T> visitor) throws MatrixVisitorException;
	 ...
	 * @see #walkInOptimizedOrder(FieldMatrixPreservingVisitor, int, int, int,
	 *      int)
	 * @return the value returned by {@link FieldMatrixPreservingVisitor#end()}
	 *         at the end of the walk
	 */
	T walkInRowOrder(FieldMatrixPreservingVisitor<T> visitor) throws MatrixVisitorException;
	 ...
	 *         the end of the walk
	 */
	T walkInColumnOrder(FieldMatrixChangingVisitor<T> visitor) throws MatrixVisitorException;
	 ...
	 *         at the end of the walk
	 */
	T walkInColumnOrder(FieldMatrixPreservingVisitor<T> visitor) throws MatrixVisitorException;
	...
	T walkInColumnOrder(FieldMatrixPreservingVisitor<T> visitor, int startRow, int endRow, int startColumn,
			int endColumn) throws MatrixIndexException, MatrixVisitorException;
	 ...
	 *         the end of the walk
	 */
	T walkInOptimizedOrder(FieldMatrixChangingVisitor<T> visitor) throws MatrixVisitorException;
	 ...
	 *         at the end of the walk
	 */
	T walkInOptimizedOrder(FieldMatrixPreservingVisitor<T> visitor) throws MatrixVisitorException;
