...
/**
 * This class implements a step interpolator for the Gill fourth order
 * Runge-Kutta integrator.
 *
 * <p>
 * This interpolator allows to compute dense output inside the last step
 * computed. The interpolation equation is consistent with the integration
 * scheme :
 *
 * <pre>
 ...
 * </pre>
 * 
 * where theta belongs to [0 ; 1], q = sqrt(2) and where y'_1 to y'_4 are the
 * four evaluations of the derivatives already computed during the step.
 * </p>
 *
 * @see GillIntegrator
...
class GillStepInterpolator extends RungeKuttaStepInterpolator {
	 ...
	 * initialization in some cases. The {@link RungeKuttaIntegrator} class uses
