...
public class TestProblemFactory {
	...
	/** Problems pool. */
	private static TestProblemAbstract[] pool = { new TestProblem1(), new TestProblem2(), new TestProblem3(),
			new TestProblem4(), new TestProblem5(), new TestProblem6() };

	/**
	 * Private constructor. This is a utility class, so there are no instance at
	 * all.
	 */
