...
public class DormandPrince54StepInterpolatorTest {
	...
	public void derivativesConsistency() throws DerivativeException, IntegratorException {
		...
		DormandPrince54Integrator integ = new DormandPrince54Integrator(minStep, maxStep, scalAbsoluteTolerance,
	...
	@Test
	public void checkClone() throws DerivativeException, IntegratorException {
		TestProblem3 pb = new TestProblem3(0.9);
		double minStep = 0;
		double maxStep = pb.getFinalTime() - pb.getInitialTime();
		double scalAbsoluteTolerance = 1.0e-8;
