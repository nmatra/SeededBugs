...
public class BlockRealMatrix extends AbstractRealMatrix implements Serializable {
	 ...
	 * @see #BlockRealMatrix(int, int, double[][], boolean)
	 */
	public static double[][] toBlocksLayout(final double[][] rawData) throws IllegalArgumentException {
	...
	/** {@inheritDoc} */
	@Override
	public BlockRealMatrix add(final RealMatrix m) throws IllegalArgumentException {
		try {
	 ...
	 */
	public BlockRealMatrix add(final BlockRealMatrix m) throws IllegalArgumentException {
	...
	/** {@inheritDoc} */
	@Override
	public BlockRealMatrix subtract(final RealMatrix m) throws IllegalArgumentException {
		try {
	 ...
	 *             if m is not the same size as this
	 */
	public BlockRealMatrix subtract(final BlockRealMatrix m) throws IllegalArgumentException {
	...
	/** {@inheritDoc} */
	@Override
	public BlockRealMatrix scalarAdd(final double d) throws IllegalArgumentException {
	...
	/** {@inheritDoc} */
	@Override
	public RealMatrix scalarMultiply(final double d) throws IllegalArgumentException {
	...
	/** {@inheritDoc} */
	@Override
	public BlockRealMatrix multiply(final RealMatrix m) throws IllegalArgumentException {
		try {
						...
						for (int nStart = 0; nStart < jWidth; ++nStart) {
							...
							while (l < lEnd - 3) {
								sum += tBlock[l] * mBlock[n] + tBlock[l + 1] * mBlock[n + jWidth]
										+ tBlock[l + 2] * mBlock[n + jWidth2] + tBlock[l + 3] * mBlock[n + jWidth3];
								l += 4;
								n += jWidth4;
							}
							while (l < lEnd) {
	...
	/** {@inheritDoc} */
	@Override
	public BlockRealMatrix getRowMatrix(final int row) throws MatrixIndexException {
	...
	/** {@inheritDoc} */
	@Override
	public BlockRealMatrix getColumnMatrix(final int column) throws MatrixIndexException {
		...
		for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
			...
			for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
				...
				for (int p = pStart, k = 0; p < pEnd; ++p) {
					...
					int q = qStart;
					while (q < qEnd - 3) {
						sum += block[k] * v[q] + block[k + 1] * v[q + 1] + block[k + 2] * v[q + 2]
								+ block[k + 3] * v[q + 3];
						k += 4;
						q += 4;
					}
		...
		for (int jBlock = 0; jBlock < blockColumns; ++jBlock) {
			...
			for (int iBlock = 0; iBlock < blockRows; ++iBlock) {
				...
				for (int q = qStart; q < qEnd; ++q) {
					...
					int p = pStart;
					while (p < pEnd - 3) {
						sum += block[k] * v[p] + block[k + jWidth] * v[p + 1] + block[k + jWidth2] * v[p + 2]
