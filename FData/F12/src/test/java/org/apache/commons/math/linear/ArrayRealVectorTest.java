...
public class ArrayRealVectorTest extends TestCase {
	...
	public void testMisc() {
		...
		/*
		 * double[] dout1 = v1.copyOut(); assertEquals("testData len", 3,
		 * dout1.length); assertNotSame("testData not same object ", v1.data,
		 * dout1);
		 */
		try {
	...
	public void testPredicates() {
		...
		assertTrue(new ArrayRealVector(new double[] { Double.NaN, 1, 2 })
				.hashCode() != new ArrayRealVector(new double[] { 0, 1, 2 }).hashCode());
