 ...
 * <p>
 * Muller's method converges almost quadratically near roots, but it can be very
 * slow in regions far away from zeros. Test runs show that for reasonably good
 * initial values, for a default absolute accuracy of 1E-6, it generally takes 5
...
public final class MullerSolverTest extends TestCase {
	...
	public void testDeprecated() throws MathException {
		...
		max = 4.0;
		expected = Math.PI;
		tolerance = Math.max(solver.getAbsoluteAccuracy(), Math.abs(expected * solver.getRelativeAccuracy()));
	 ...
	 * <p>
	 * It takes 10 to 15 iterations for the last two tests to converge. In fact,
	 * if not for the bisection alternative, the solver would exceed the default
	 * maximal iteration of 100.
	 */
