...
public class VectorialPointValuePair implements Serializable {
	 ...
	 * 
	 * @param point
	 *            point coordinates (the built instance will store a copy of the
	 *            array, not the array passed as argument)
	 * @param value
	 ...
	 *            value of an objective function at the point
	 * @param copyArray
	 *            if true, the input arrays will be copied, otherwise they will
	 *            be referenced
	 */
	 ...
	 * <p>
	 * This method is provided as a convenience to avoid copying the array, the
	 * elements of the array should <em>not</em> be modified.
	 * </p>
	 * 
