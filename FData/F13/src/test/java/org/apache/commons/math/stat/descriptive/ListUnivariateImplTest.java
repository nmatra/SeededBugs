...
public final class ListUnivariateImplTest extends TestCase {
	...
	public void testSkewAndKurtosis() {
		...
		double[] testArray = { 12.5, 12, 11.8, 14.2, 14.9, 14.5, 21, 8.2, 10.3, 11.3, 14.1, 9.9, 12.2, 12, 12.1, 11,
	...
	public void testProductAndGeometricMean() throws Exception {
		...
		// Now test rolling - StorelessDescriptiveStatistics should discount the
		// contribution
