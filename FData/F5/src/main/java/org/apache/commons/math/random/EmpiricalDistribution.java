 ...
 * <li>reporting univariate statistics describing the full set of data values as
 * well as the observations within each bin</li>
 * <li>generating random values from the distribution</li>
 * </ul>
 * Applications can use <code>EmpiricalDistribution</code> implementations to
 * build grouped frequency histograms representing the input data or to generate
 * random values "like" those in the input file -- i.e., the values generated
 * will follow the distribution of the values in the file.
 * </p>
 * 
...
public interface EmpiricalDistribution {
	 ...
	 * describing this distribution. <strong>Preconditions:</strong>
	 * <ul>
	 * <li>the distribution must be loaded before invoking this method</li>
	 * </ul>
	 * 
	 ...
	 * containing statistics describing the values in each of the bins. The List
	 * is indexed on the bin number.
	 * 
