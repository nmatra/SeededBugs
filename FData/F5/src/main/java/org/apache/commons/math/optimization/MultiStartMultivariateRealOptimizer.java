...
/**
 * Special implementation of the {@link MultivariateRealOptimizer} interface
 * adding multi-start features to an existing optimizer.
 * <p>
 * This class wraps a classical optimizer to use it several times in turn with
 * different starting points in order to avoid being trapped into a local
 * extremum when looking for a global one.
 * </p>
 * 
...
public class MultiStartMultivariateRealOptimizer implements MultivariateRealOptimizer {
	 ...
	 */
	public MultiStartMultivariateRealOptimizer(final MultivariateRealOptimizer optimizer, final int starts,
	 ...
	 * by the {@link #optimize(MultivariateRealFunction, GoalType, double[])
	 * optimize} method.
	 * </p>
	 * <p>
	 ...
	 * {@link #optimize(MultivariateRealFunction, GoalType, double[]) optimize}
	 * method did throw a {@link ConvergenceException ConvergenceException}).
	 ...
	 *                if
	 *                {@link #optimize(MultivariateRealFunction, GoalType, double[])
	...
	/** {@inheritDoc} */
	public RealPointValuePair optimize(final MultivariateRealFunction f, final GoalType goalType, double[] startPoint)
		...
		if (optima[0] == null) {
			throw new OptimizationException("none of the {0} start points lead to convergence", starts);
		}
