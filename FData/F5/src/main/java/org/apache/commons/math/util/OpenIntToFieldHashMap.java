 ...
 * @version $Revision: 746578 $ $Date: 2009-02-21 12:01:14 -0800 (Sat, 21 Feb
 *          2009) $
 * @since 2.0
 */
public class OpenIntToFieldHashMap<T extends FieldElement<T>> implements Serializable {
	...
	/**
	 * Build an empty map with specified size and using zero for missing
	 * entries.
	 * 
	 * @param field
	 *            field to which the elements belong
		...
		public int key() throws ConcurrentModificationException, NoSuchElementException {
			if (referenceCount != count) {
				throw MathRuntimeException
						.createConcurrentModificationException("map has been modified while iterating");
			}
			if (current < 0) {
